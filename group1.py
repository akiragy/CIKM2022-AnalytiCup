...
cfg_file = 'federatedscope/gfl/baseline/group1_glb.yaml'
client_cfg_file = 'federatedscope/gfl/baseline/group1_lco.yaml'
...
if __name__ == '__main__':
    ...
    init_cfg.federate.total_round_num = 10000
    init_cfg.freeze()
